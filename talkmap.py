...
#
# Run this from the _representative_works/ directory, which contains .md files of all your
# representative_works. This scrapes the location YAML field from each .md file, geolocates it
